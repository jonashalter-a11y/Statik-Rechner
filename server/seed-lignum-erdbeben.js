      ...
      "nodes": [
        ...
        },
        {
          ...
          "data": {
            "kind": "calc",
            "name": "f_{v,d}",
            "label": "Schubnachweis nach DIN 1995-1-1/NA",
            "unit": "N/mm^2",
            "latex": "f_{v,d} = \\frac {\\eta_{mod}}{\\gamma_M} \\cdot f_{v,k}",
            "expr": "(eta_mod / gamma_M) * f_v_k"
          }
        }
      ],
      "edges": [
        ...
        {
          "id": "e_drop_table",
          "source": "dropdown_plattenart",
          "target": "tablevalue_fvk",
          "sourceHandle": null,
          "targetHandle": null,
          "data": {
            "kind": "workflow"
      ...
      "nodes": [
        ...
        },
        {
          ...
          "data": {
            "kind": "minmax",
            "name": "f_{v,0,d}",
            "label": "Bemessungswert der längenbezogenen Schubfestigkeit",
            "unit": "N/mm",
            "latex": "f_{v,0,d} = \\min \\begin{cases} k_{v1} \\cdot R_d / a_v \\cdot n_{Reihe} \\cdot n_{Beplankung} \\\\ k_{v1} \\cdot k_{v2} \\cdot f_{v,d} \\cdot t \\cdot n_{Beplankung} \\\\ k_{v1} \\cdot k_{v2} \\cdot f_{v,d} \\cdot 35 \\cdot t^2 / a_r \\cdot n_{Beplankung} \\end{cases}",
            "expr": "Math.min(k_v1 * R_d / a_v * n_Reihe * n_Beplankung, k_v1 * k_v2 * f_v_d * t * n_Beplankung, k_v1 * k_v2 * f_v_d * 35 * Math.pow(t,2) / a_r * n_Beplankung)"
          }
        }
      ],
      "edges": [
